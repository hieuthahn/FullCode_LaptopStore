...
function ready() {
    ...
    //var searchButtons = document.getElementsByClassName('header__search-btn');
    //for (var i = 0; i < searchButtons.length; i++) {
    //    var button = searchButtons[i];
    //    button.addEventListener('click', BoxSearchValid);
    //}

    //var categoryActive = document.getElementsByClassName('category-item');
    //for (var i = 0; i < categoryActive.length; i++) {
    //    var button = categoryActive[i];
    //    button.addEventListener('click', categoryActiveClicked);
    //}

    document.getElementsByClassName('cart__footer-btn-pay')[0].addEventListener('click', purchaseClicked);
    document.getElementsByClassName('header__search-new')[0].addEventListener('click', BoxSearchValid);
}
...
function categoryActiveClicked() {
    document.getElementsByClassName("category-item").classList.add("category-item--active");;
}

function BoxSearchValid()
{
    alert('Cảm ơn bạn đã mua hàng tại Laptop-World');
    return;
    //var text = document.getElementsByClassName("header__search-input");
    //if (text == "" || text == null)
    //{
    //    alert("Bạn cần nhập vào ô tìm kiếm");
    //    return;
    //}
}
